...
final class Version20230510224541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT IDENTITY NOT NULL, login_id INT NOT NULL, title NVARCHAR(255) NOT NULL, body VARCHAR(MAX), date DATETIME2(6) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_23A0E665CB2E05D ON article (login_id)');
        $this->addSql('CREATE TABLE login (id INT IDENTITY NOT NULL, email NVARCHAR(180) NOT NULL, roles VARCHAR(MAX) NOT NULL, password NVARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_AA08CB10E7927C74 ON login (email) WHERE email IS NOT NULL');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E665CB2E05D FOREIGN KEY (login_id) REFERENCES login (id)');
